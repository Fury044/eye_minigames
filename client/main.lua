...
if Config.EnableTestCommands then
    local categories = {
        ...
        advanced   = { 'overflow', 'breachmatrix', 'daemonrun', 'pulse', 'hottrace', 'cascade', 'lightsout', 'slidepuzzle' },
        aaa        = { 'resonance', 'intrusion', 'override', 'animus', 'eaglevision', 'parry', 'constellation', 'archery' },
        jobs       = { 'fishing', 'mining', 'cooking', 'welding', 'harvest', 'drilling', 'locksmith', 'hotwire', 'crafting', 'lugnuts', 'paintspray', 'crane', 'forge', 'diving' },
        mechanic   = { 'partsort', 'toolbox', 'packing', 'beltsort' },
        crime      = { 'tripwire', 'pickpocket', 'getaway', 'cashcount', 'counterfeit', 'chopshop' },
